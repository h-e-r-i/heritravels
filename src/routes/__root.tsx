...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "H.E.R.I (Higher Evolution Remote Intelligence) — an AI copilot for navigation, weather, flights, and exploration. Your best friend that goes with you everywhere." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#0a1024" },
      { name: "twitter:title", content: "H.E.R.I — Wings of Excellence" },
      { name: "twitter:description", content: "H.E.R.I (Higher Evolution Remote Intelligence) — an AI copilot for navigation, weather, flights, and exploration. Your best friend that goes with you everywhere." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/01ab4285-fe6f-4fd6-bc42-6e988e4ed86a" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/01ab4285-fe6f-4fd6-bc42-6e988e4ed86a" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", type: "image/png", href: "/__l5e/assets-v1/78c2f5b7-7883-427b-b79b-fec74c6f7a6a/heri-logo.png" },
    ],
  }),
